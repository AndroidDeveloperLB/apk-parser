...
//            XapkTestHandlerFramework1(context).runTest(xapkFile, deviceConfig, appIconSize, preferApacheApi)
//            XapkTestHandlerFramework2(context).runTest(xapkFile, deviceConfig, appIconSize, preferApacheApi)
//            XapkTestHandlerFramework3(context).runTest(xapkFile, deviceConfig, appIconSize, preferApacheApi)
//            XapkTestHandlerFramework4(context).runTest(xapkFile, deviceConfig, appIconSize, useMemCache, preferApacheApi)
//            XapkTestHandlerFramework5(context).runTest(xapkFile, deviceConfig, appIconSize, useMemCache, preferApacheApi)
