...
class XapkTestHandlerFramework2(private val context: Context) {
    ...
    private fun getApkInfo(context: Context, xapkFile: ZipFile, entry: ZipEntry, deviceConfig: DeviceConfig): ApkInfo? {
        return try {
    ...
    private fun createZipFilter(context: Context, xapkFile: ZipFile, entry: ZipEntry): AbstractZipFilter {
